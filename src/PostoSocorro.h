...
public:
	//construtor
	Bombeiros():PostoSocorro(){this->numero_Ambulancias=0;this->numero_Autotanques=0;}
	...
	std::string getTipo(){return "Bombeiros";}
